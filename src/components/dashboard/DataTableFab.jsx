...
function filterDataTableFab({ title, addBtnTitle, filterParameters, tableTitles, orderDataTable, actionsTableButton, fetchDataFunction, postDataFunction, formModal: FormModal }) {
...
export default filterDataTableFab
